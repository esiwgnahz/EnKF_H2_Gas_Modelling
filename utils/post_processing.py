...
class post_calculation:
    ...
    def spread_calculation(self):
        ...
        for i in range(1,self.t+1):
            args=r'E:\ENKF_LabGasInjec2\t_%d.txt' % i
            f=open(args,'r')
            content=f.readlines()
            ...
            std=math.sqrt(np.mean(var,axis=0))
            a[i-1]=std
            pass
    ...
    def rmse_calculation(self):
        para_args=r'E:\ENKF_LabGasInjec2\true_obs\para_true.txt'
        ...
        parY_args=r'E:\ENKF_LabGasInjec2\parY.txt'
